...
- build(deps): bump tokio from 1.52.1 to 1.52.3 [`#606`](https://github.com/hougesen/hitt/pull/606)
- build(deps): bump assert_cmd from 2.2.1 to 2.2.2 [`#607`](https://github.com/hougesen/hitt/pull/607)
- build(deps): bump clap_complete from 4.6.4 to 4.6.5 [`#608`](https://github.com/hougesen/hitt/pull/608)
- build(deps): bump clap from 4.6.0 to 4.6.1 [`#600`](https://github.com/hougesen/hitt/pull/600)
- build(deps): bump clap_complete from 4.6.3 to 4.6.4 [`#605`](https://github.com/hougesen/hitt/pull/605)
- build(deps): bump assert_cmd from 2.2.0 to 2.2.1 [`#599`](https://github.com/hougesen/hitt/pull/599)
- build(deps): bump tokio from 1.50.0 to 1.52.1 [`#602`](https://github.com/hougesen/hitt/pull/602)
- build(deps): bump rand from 0.9.2 to 0.9.4 [`#597`](https://github.com/hougesen/hitt/pull/597)
- build(deps): bump JohnnyMorganz/stylua-action from 4 to 5 [`#594`](https://github.com/hougesen/hitt/pull/594)
- build(deps): bump rustls-webpki from 0.103.10 to 0.103.13 [`#598`](https://github.com/hougesen/hitt/pull/598)
- build(deps): bump clap_complete from 4.6.0 to 4.6.3 [`#603`](https://github.com/hougesen/hitt/pull/603)
- build(deps): bump reqwest from 0.13.2 to 0.13.3 [`#604`](https://github.com/hougesen/hitt/pull/604)
- build(deps): bump codecov/codecov-action from 5 to 6 [`#592`](https://github.com/hougesen/hitt/pull/592)
- build(deps): bump rustls-webpki from 0.103.8 to 0.103.10 [`#591`](https://github.com/hougesen/hitt/pull/591)
- build(deps): bump assert_cmd from 2.1.2 to 2.2.0 [`#590`](https://github.com/hougesen/hitt/pull/590)
- build(deps): bump clap_complete_nushell from 4.5.10 to 4.6.0 [`#589`](https://github.com/hougesen/hitt/pull/589)
- build(cargo-dist): upgrade to v0.31.0 [`#588`](https://github.com/hougesen/hitt/pull/588)
- build(deps): bump predicates from 3.1.3 to 3.1.4 [`#580`](https://github.com/hougesen/hitt/pull/580)
- build(deps): bump quinn-proto from 0.11.13 to 0.11.14 [`#586`](https://github.com/hougesen/hitt/pull/586)
- build(deps): bump bytes from 1.11.0 to 1.11.1 [`#574`](https://github.com/hougesen/hitt/pull/574)
- build(deps): bump time from 0.3.44 to 0.3.47 [`#575`](https://github.com/hougesen/hitt/pull/575)
- build(deps): bump tempfile from 3.24.0 to 3.26.0 [`#584`](https://github.com/hougesen/hitt/pull/584)
- build(deps): bump clap from 4.5.54 to 4.5.60 [`#583`](https://github.com/hougesen/hitt/pull/583)
- build(deps): bump futures from 0.3.31 to 0.3.32 [`#582`](https://github.com/hougesen/hitt/pull/582)
...
- build(deps): bump clap from 4.5.53 to 4.5.54 [`#569`](https://github.com/hougesen/hitt/pull/569)
- build(deps): upgrade reqwest to v0.13.1 [`#567`](https://github.com/hougesen/hitt/pull/567)
...
- build(deps): bump clap from 4.5.51 to 4.5.53 [`#557`](https://github.com/hougesen/hitt/pull/557)
- build(deps): bump actions/checkout from 5 to 6 [`#559`](https://github.com/hougesen/hitt/pull/559)
- build(cargo-dist): upgrade to v0.30.2 [`#555`](https://github.com/hougesen/hitt/pull/555)
- build(deps): bump clap_complete from 4.5.59 to 4.5.60 [`#552`](https://github.com/hougesen/hitt/pull/552)
- build(deps): bump ignore from 0.4.24 to 0.4.25 [`#553`](https://github.com/hougesen/hitt/pull/553)
- build(deps): bump clap_complete_nushell from 4.5.9 to 4.5.10 [`#554`](https://github.com/hougesen/hitt/pull/554)
- refactor(test): use cargo_bin_cmd [`#551`](https://github.com/hougesen/hitt/pull/551)
- build(deps): bump clap from 4.5.50 to 4.5.51 [`#549`](https://github.com/hougesen/hitt/pull/549)
- build(deps): bump assert_cmd from 2.0.17 to 2.1.1 [`#550`](https://github.com/hougesen/hitt/pull/550)
- build(deps): bump clap_complete from 4.5.58 to 4.5.59 [`#542`](https://github.com/hougesen/hitt/pull/542)
- build(deps): bump reqwest from 0.12.23 to 0.12.24 [`#541`](https://github.com/hougesen/hitt/pull/541)
- build(deps): bump clap_complete_nushell from 4.5.8 to 4.5.9 [`#540`](https://github.com/hougesen/hitt/pull/540)
- build(deps): bump tokio from 1.47.1 to 1.48.0 [`#543`](https://github.com/hougesen/hitt/pull/543)
- build(deps): bump clap from 4.5.48 to 4.5.50 [`#544`](https://github.com/hougesen/hitt/pull/544)
- build(deps): bump ignore from 0.4.23 to 0.4.24 [`#546`](https://github.com/hougesen/hitt/pull/546)
- build: use default runners for cargo-dist [`#537`](https://github.com/hougesen/hitt/pull/537)
...
- build(cargo-dist): bump version to v0.30.0 [`#533`](https://github.com/hougesen/hitt/pull/533)
